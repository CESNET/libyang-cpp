 ...
 */
void DataNode::newAttrOpaqueJSON(const std::string& moduleName, const std::string& attrName, const std::string& attrValue) const
{
    if (!isOpaque()) {
    ...
    lyd_new_attr(m_node, moduleName.c_str(), attrName.c_str(), attrValue.c_str(), nullptr);
}
