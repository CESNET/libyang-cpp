...
/*
 * Parses YANG data into an operation data tree. Currently only supports
 * OperationType::ReplyNetconf. For OperationType::RpcNetconf, use Context::parseOp.
 */
 ...
 * validation can potentially a libyang::DataNode to a std::nullopt through the passed reference.
 */
