...
Value DataNodeTerm::value() const
{
    ...
    case LY_TYPE_LEAFREF:
        // TODO: Unions and (probably) leafrefs aren't resolved to the underlying types, so I'll (probably) need to make
        // the function recursive somehow... or maybe return a variant of a variant and leave the recursion to the
        // caller? Not sure.
