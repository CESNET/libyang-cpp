...
/*
 * Parses YANG data into an operation data tree. Currently only supports OperationType::RpcNetconf. For
 * OperationType::RpcNetconf, use DataNode::ReplyNetconf after using this method.
 */
