 ...
 * means enable all features. std::nullopt means no change to enabled features (for already implemented modules) or no
 * features enabled (for modules about to be implemented).
 */
