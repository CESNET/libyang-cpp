...
public:
    ...
    DataNode newExtPath(const std::string& path, const ExtensionInstance& ext, const std::optional<std::string>& value, const std::optional<CreationOptions> options) const;
