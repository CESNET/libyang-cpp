...
TEST_CASE("SchemaNode")
{
    ...
    DOCTEST_SUBCASE("Decimal::range")
    {
        ...
        REQUIRE(d_type1.range().parts[0].minInt64 == -9223372036854775808);
        ...
        REQUIRE(d_type1.range().parts[2].maxInt64 == 9223372036854775807);
        ...
        REQUIRE(d_type2.range().parts[0].minInt64 == -9223372036854775808);
        REQUIRE(d_type2.range().parts[0].maxInt64 == -5123456789123456789);
        REQUIRE(d_type2.range().parts[1].minInt64 == 5123456789123456789);
        REQUIRE(d_type2.range().parts[1].maxInt64 == 9223372036854775807);
        ...
        REQUIRE(d_type3.range().parts[0].minInt64 == -9223372036854775808);
        REQUIRE(d_type3.range().parts[0].maxInt64 == 9223372036854775807);
