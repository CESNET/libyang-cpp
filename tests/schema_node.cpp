...
TEST_CASE("SchemaNode")
{
    ...
    {
        REQUIRE(ctx->findPath("/type_module:leafListWithDefault").asLeafList().defaultValuesStr().size() == 2);
        REQUIRE(ctx->findPath("/type_module:leafListWithDefault").asLeafList().defaultValuesStr().at(1) == "512");
