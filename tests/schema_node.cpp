...
TEST_CASE("SchemaNode")
{
    ...
    DOCTEST_SUBCASE("Choice and Case")
    {
        ...
        {
            REQUIRE(!basicChoice.defaultCase().has_value());
            REQUIRE(choiceWithDefault.defaultCase().value().name() == "case1");
            REQUIRE(!choiceWithMandatory.defaultCase().has_value());
        }
        ...
        DOCTEST_SUBCASE("Choice::cases")
        {
            DOCTEST_SUBCASE("with cases")
            {
                ...
                REQUIRE(basicCases.at(0).asCase().name() == "case1");
                REQUIRE(basicCases.at(0).asCase().immediateChildren().begin()->asLeaf().name() == "choiceBasicLeaf1");
                REQUIRE(basicCases.at(1).asCase().name() == "case2");
                REQUIRE(basicCases.at(1).asCase().immediateChildren().begin()->asLeaf().name() == "choiceBasicLeaf2");
                ...
                REQUIRE(choiceWithDefaultCases.at(0).asCase().name() == "case1");
                REQUIRE(choiceWithDefaultCases.at(1).asCase().name() == "case2");

                auto choiceWithMandatoryCases = choiceWithMandatory.cases();
                REQUIRE(choiceWithMandatoryCases.size() == 2);
                REQUIRE(choiceWithMandatoryCases.at(0).asCase().name() == "case1");
                REQUIRE(choiceWithMandatoryCases.at(1).asCase().name() == "case2");
            }

            DOCTEST_SUBCASE("without cases")
            {
                REQUIRE(!choiceWithoutCaseContainer.immediateChildren().empty());
                REQUIRE(choiceWithoutCaseContainer.immediateChildren().begin()->asLeaf().name() == "choiceWithoutCaseLeaf1");
            }
        }
    }
