    ...
    DOCTEST_SUBCASE("Choice and Case")
    {
        ...
        DOCTEST_SUBCASE("Choice::cases")
        {
            DOCTEST_SUBCASE("with cases")
            {
                ...
                REQUIRE((++basicCases.at(0).asCase().immediateChildren().begin())->asLeafList().name() == "choiceBasicLeafList1");
            ...
            DOCTEST_SUBCASE("without explicitly specified case")
            {
                ...
                REQUIRE(choiceWithoutCase.cases().at(0).asCase().name() == "choiceWithoutCaseLeaf1");
            }
        }
    }
