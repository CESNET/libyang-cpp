...
TEST_CASE("Data Node manipulation")
{
  ...
  "example-schema:poke-a-friend": {
    "friend": "Kuba"
                ...
                libyang::validateOp(*rpcTree, depTree, libyang::OperationType::RpcYang);
            ...
            DOCTEST_SUBCASE("Nodes in disjunctive cases defined together")
            {
                ...
                REQUIRE_THROWS_WITH_AS(libyang::validateOp(rpcTree, std::nullopt, libyang::OperationType::RpcYang), "libyang:validateOp: lyd_validate_op failed: LY_EVALID", libyang::Error);
            }
