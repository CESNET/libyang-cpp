...
TEST_CASE("Data Node manipulation")
{
  ...
  "sysrepo:discard-items": "/example-schema:b"
    ...
    DOCTEST_SUBCASE("Extension nodes")
    {
        ...
        auto node = ctx.newExtPath("/ietf-restconf:errors", mod.extensionInstance("yang-errors"), std::nullopt, std::nullopt);
  ...
  "ietf-restconf:errors": {}
        ...
        REQUIRE(node.newPath("ietf-restconf:error[2]/error-type", "transport"));
        REQUIRE(node.newPath("ietf-restconf:error[2]/error-tag", "invalid-attribute"));
